...
import { Bot, LayoutDashboard, Brain, MessageSquare, Activity, Settings, ChevronDown, LogOut, User } from 'lucide-react';
...
const sidebarItems = [
  ...
  { href: '/agents', label: 'AI Agents', icon: MessageSquare },
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white border-r overflow-y-auto">
        <div className="p-4 border-b">
          <Link to="/dashboard" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold">TawkAI</span>
          </Link>
        </div>
